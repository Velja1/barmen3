var selectAdmin=document.getElementById("ddlAdmin");
selectAdmin.addEventListener("change",provera);
...
ajaxCallBack("upis.php","post",podaciZaSlanje,function(result){
...
function proveraPlovilaIzmena(){
    ...
    if(izabranoPlovilo!=0){
        ajaxCallBack("izmena.php", "post", izabranoPloviloSlanje, function(result){
...
ajaxCallBack("izmena_upis.php","post",podaciZaSlanje,function(result){
...
function proveraBrisanje(){
    ...
    ajaxCallBack("brisanje.php","post",podaciZaSlanje,function(result){
...
function proveraAnketa(){
    ...
    ajaxCallBack("anketa_provera.php","post",podaciZaSlanje,function(result){
