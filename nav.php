        ...
        <header id="header" class="rel">
            ...
            <nav id="nav">
                <ul>
                    <?php
						global $conn;
						$upit="SELECT * FROM meni WHERE lokacija = 'header' AND href NOT LIKE 'admin.php'";
					...
					<?php
                        ...
                        if(isset($_SESSION['korisnik'])&&$_SESSION['korisnik']->id_uloga==1):
                            global $conn;
                            $upit="SELECT * FROM meni WHERE lokacija = 'header' AND href='admin.php'";
                            $adminMeni=$conn->query($upit)->fetch();
					?>
                    <li><a href="<?=$adminMeni->href?>"><?=$adminMeni->naziv?></a></li>
                </ul>
                <?php
                    endif;
                ?>
